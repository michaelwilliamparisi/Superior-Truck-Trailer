...
class WorkOrderList extends StatefulWidget {
  ...
  @override
  State<WorkOrderList> createState() =>
      _MyWorkOrderState(workOrders, trailer, employeeCode);
}
                    ...
                    children: [
                      ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            ...
                            backgroundColor:
                                const Color.fromARGB(255, 136, 186, 226),
                          ),
                          child: Image.asset(
                            'asset/images/completed.png',
                            width: 30,
                            height: 30,
                          ),
                          onPressed: () {
                            DatabaseHandler.WorkOrderStatus(trailer.trailerId,
                                workOrders[index].workOrderNum, 'C');
                            workOrders.removeAt(index);
                            setState(() {
                              _MyWorkOrderState(
                                  workOrders, trailer, employeeCode);
                            });
                          }),
                      ElevatedButton(
                          style: ElevatedButton.styleFrom(
                          ...
                          onPressed: () {
                            showDialog<String>(
                              ...
                              builder: (BuildContext context) => AlertDialog(
                                title: Text(
                                    "Delete Work Order ${workOrders[index].workOrderNum}"),
                                content: const Text(
                                    "Are you sure you want to delete this Work Order?"),
                                actions: <Widget>[
                                  TextButton(
                                    onPressed: () {
                                      DatabaseHandler.WorkOrderStatus(
                                          trailer.trailerId,
              ...
              return ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CreateWorkOrder(
                            trailer: trailer,
                            workOrders: workOrders,
                            employeeCode: employeeCode,
                          ),
